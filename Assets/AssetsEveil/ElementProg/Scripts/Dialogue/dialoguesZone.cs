...
public class dialoguesZone : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            Debug.Log("Je: " + this.gameObject.name + " n'a pas de liste de dialogues associ�e! Tu as oubli� de checkmark l'une des trois options!");
        }
    }
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.gameObject.tag == "Player")
        {
            ...
            { // Dialogue random = un d�lais random avant de le mettre
    ...
    private IEnumerator boucleDialogueRandom()
    {
        ...
        if (joueurDansZone)
        {
            dialogueManager.GetComponent<dialoguesManager>().arretSon();
